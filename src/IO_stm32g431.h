...
#define ADC1_SAMPLE_TIME                    LL_ADC_SAMPLINGTIME_12CYCLES_5//LL_ADC_SAMPLINGTIME_2CYCLES_5//LL_ADC_SAMPLINGTIME_47CYCLES_5

#define ADC2_CHANNELS_COUNT                 1
#define	ADC2_CH3_VOLTAGE_CHANNEL            3
#define ADC2_NUMBER_LIST                    {ADC2_CH3_VOLTAGE_CHANNEL}
#define ADC2_SAMPLE_TIME                    LL_ADC_SAMPLINGTIME_47CYCLES_5//LL_ADC_SAMPLINGTIME_47CYCLES_5
